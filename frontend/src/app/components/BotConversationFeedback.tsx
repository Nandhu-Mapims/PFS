...
type Phase = "loading" | "identity" | "intro" | "question" | "submitting";
...
export function BotConversationFeedback() {
  ...
  }, [clearTimers, startRecording, thinkSeconds]);
  ...
  }, [identity, sortedQuestions.length, playIntroAudio, goToFirstQuestion]);
